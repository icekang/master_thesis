...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/result_SwinUNETR_results.png}
    \caption{Dice score of SuPreM's SwinUNTER model.}
    \label{fig:suprem-results}
\end{figure}

However, comparing the results of SuPreM's SwinUNTER model with the best 2D nnUNet model, we find that the 2D nnUNet model outperforms the SuPreM's SwinUNTER model. We will discuss this the next section.

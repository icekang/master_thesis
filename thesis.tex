...
% and show them with \texttt{\textbackslash{}makeacks}.
    ...
    I would like to express my deep gratitude to my mom and dad for their unwavering support and firm faith in letting me choose my path. My mom has always been the best example of patience, kindness, and forgiveness. My dad has always exemplified perseverance, honesty, self-improvement, and open-mindedness. Both of them have sacrificed so much to raise their children, ensuring that we have the best education, the best guidance to lead our lives, and the strongest resilience to face the world on our own. They have provided all of this while veiling the stress of daily life, financial hardships, and the occasional sadness that comes with being human. I hope to be like them one day, and I am striving to be their source of comfort, letting them know they can rely on me, both physically and emotionally, because I love them as much as they love me.
    
    I would like to thank my two wonderful sisters, Namking and Namkow, for their continuous support and love. They are my first friends and have taught me the importance of caring and sharing. My older sister has always protected me and paved the way for me to follow. She went to school before me, took exams before me, and shared her experiences and wisdom so I could navigate the same challenges with ease. My younger sister taught me to be brave and to speak up for myself. She chose to study arts, excelled, and earned a top rank in a high school art program. She spoke her mind and stood by it. I have learned so much from them.

    I would like to express my love for my aunt, who is the funniest person I know, and for my grandma, whom I loved the most but lost to COVID-19. She knew that I would be studying in Switzerland, but I regret that she won't be able to see me graduate. I wish she were still here, as she was the loveliest lady who constantly gave me warmth.

    Friendship is the most valuable thing I find, and I am so grateful to be the luckiest one who have so much of it throughout my life. Perterpan and Gammam were my two best friends during elementary school, who were the reason I was excited to go to school every day. They were the reason I made so many friends throughout my life, which was surprising as how easy it was to establish friendship, by asking if blue was the favorite color, or just jumping on someone back.
    
    The spark of interest in computer began with my best friend, Copter, whom I met during the middle school and played Minecraft together after the school every single day. We were a comfort zone for each other to share all the ups and downs of our lives. Nat and Dream were also my best friends who shared a lot of fond memories during that time. 
    
    As life went on, Meak, my best friend, came up to me asking for my contact on the first day at our high school, and our unbroken bond started. We shared our passion, our dreams, and the world views during the class, and via telephone until late night. Korn, Man, Safe, Mon, Pong, Poom, Kwan, Yod, Park, Korn, Mew, Kuan, Sarm, Cream, Vorawee, Champ, May, Friend, Sugus, Run, Parn, and uncountable more were the people I found so lucky to have in my life, because I could find my comfort in sharing my thoughts with them, and I would not be able to be the person I am today without them. They were all of incredible minds who propelled me to study hard, and helped me to do so without hesitations. The friendly competitiveness and collaboration at the time got me to the university I dreamed, Chulalongkorn.

    The unwavering support, late-night study sessions, and constant companionship at Chulalongkorn University from V, Poom, Pinn, Pewt, Pooh, Bank, Peanut, Krist, Palm, Marie, Benz, Boom, Dear, Koon, Millie, B-one, Safefy, Aong, Ik, Kuan, Minnie, Nile, May, and may more have not only made my bachelor years enjoyable but also provided me with strength and comfort, even from thousands of kilometers away. The conversation with my best friend, V, kept me going in my life. That very long walk from MBK to home, just because we could, filled my heart every time. I would also like to thank Jump for helping me throughout the 3 years of Computer Engineering, and most importantly, for being my friend and my mentor. Connection and contact from these lovely individuals are the source of strength and comfort through unbearable days when I am away from my home. I would like to thank Prof. Proadpran Punyabukkana, Prof. Ekapol Chuangsuwanich and Prof. Atiwong Suchato for allowing me to work on research and engineering projects, providing supports and advice while letting me grow and learn which led me to EPFL.

    Moving to a new country to study at EPFL was never easy, but Ice, Set, James, Nai, and Kwang defied it. Simple dinners every evening, meaningful conversations, and trips to alpine mountains and European cities have made this little boy feel accompanied in a foreign land. Then I met Cindy, Sundae, Jenestin, Thomas, Paulina, Fah, Hong-Bin, Leo, Ting-Wei, Pin-Yen, Yi-Kai, Edvin, Aamir, and Jirka who changed my life completely. My bestie, Cindy, gives me safe space and caring like my real sister. Coffee making in the morning on Sunday, dinner cooking in the evening, and emotional support from her have made life at EPFL so delightful. I want to thank all of them for being my second family in Switzerland. I would also like to thank Andrea Settimi, Samy Tafasca, and Prof. Jean-Marc Odobez for introducing me to academic research and mentoring me which led me to MIT.

    Coming to MIT was the second major moving of my life, and it would not have been easy without the warm welcome from Pooh who showed my around Boston, and greeted me with the steaming calm chowder and buttery red lobsters in the cold winter. Life during six months in the United States would have been desolated and somnolent without a person who shares the same coffee passion, Cue. Last but not least, New England would have never been explored, White Mountains would never have been conquered, Mount Auburn would have never been visited, Zesiger center gym session would be quite lonely, and Lunch break would have never been delicious foods from Trader's Joe without knowing Mee. Without knowing these people, Pooh, Cue, Mee, Boss, Looktarn, Tah, Nut, Winn, Champ, Iker, Eli, Maryam, Jonas, Shreya, and Julie, 6 intense months would not be filled with board game nights, Vester cafe break, dance classes, and tennis sessions. I would like to thank Mee specifically for proof reading this thesis and helping out with the presentation. His knowledge and proficiency is above and beyond in reshaping my thoughts and method to convey my experiments and findings. 


   I would like to express my deepest gratitude to Prof. Elazer Edelman and Karim Kadry for granting me the unparalleled opportunity to join the Edelman Lab at MIT. Their unwavering support and guidance have been instrumental in allowing me to complete my Master's thesis here. I was truly privileged to be treated as a full-time member of the lab, with a dedicated weekly slot to meet with Prof. Elazer, and round-the-clock support from Karim. Additionally, access to the MIT SuperCloud clusters~\cite{Reuther2018Supercloud}, equipped with 8 GPUs, was invaluable for running my experiments. My time at MIT was not only about academic and research achievements but also about becoming part of a vibrant community. I was warmly welcomed into the social events, facilities, and activities at MIT, which made these six months incredibly rewarding and fulfilling.

    I would also like to extend my heartfelt thanks to Maryam for her invaluable assistance with my thesis and presentation. My sincere appreciation also goes to Farhad for arranging the group meetings, introducing me to the incredible work of Edelman's computational group, and offering valuable advice on my thesis and presentation. I would like to express my gratitude to Jessie Klapper Elliott for handling all the administrative tasks with great care, ensuring that my experience before arriving at MIT and during my time here went exceptionally smoothly. Finally, I am deeply grateful to all the wonderful people in the Edelman Lab who made my experience here both enjoyable and enriching.

    Last but not least, I am deeply grateful to Prof. Maria Brbić for facilitating my thesis abroad and providing invaluable advice that greatly influenced the direction of my research. Her support made this experience both productive and rewarding.
}

...
\begin{figure}[ht]
    ...
    \caption{Multi-features decoder head. Feature at each transformer layer is project to the same dimension and concatenated before being passed to a convolutional layer that produces the segmentation mask.}

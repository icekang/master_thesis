...
% medical imaging can highly benefit from self-supervised learning which leverages images without human annotations to improve the existing, limited datasets.
...
% basically say we also need segmentations for training synthetic anatomy diffusion models

...
% Even though these volumes are unannotated, a tabular meta-data is available for each volume. This meta-data describes the morphological properties of the calcium plaques, lumen, and wall. 

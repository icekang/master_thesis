...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\linewidth]{figures/result_VJEPA_results.png}
    \caption{Dice score of V-JEPA's decoder head. BNLinear is batch normalization followed by linear projection. Attentive is the attentive decoder head. Attentive* is attentive decoder head with more intensed data augmentation and positive data sampling rate. MultiFeat is the multi-features decoder head. In the parenthesis indicates the data used for pre-training.}
...
\begin{figure}[h]
    ...
    \caption{Dice score of CLIP on Calcium OCT dataset compared to nnUNet.}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{figures/discussion_default_feature_map_batch0_feature1.png}
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=0.9\linewidth]{figures/discussion_clip_feature_map_batch0_feature1.png}
        \caption{PCA of the features learned by CLIP.}
        \label{fig:pca-clip}
        
    \end{subfigure}
    \caption{PCA of the features output from initial weight of the model and the features learned by CLIP. CLIP pre-training gives more separable features on the walls than those from the initial weight of the model.}
\end{figure}

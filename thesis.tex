...
% and show them with \texttt{\textbackslash{}makeacks}.
    ...
    My passion for computers began with my best friend Copter, whom I met in middle school. We played Minecraft together every day after school, becoming each other’s comfort zone through life’s ups and downs. Nat and Dream, also dear friends, shared many fond memories during that time.
    ...
    Moving to Switzerland to study at EPFL was challenging, but Ice, Set, James, Nai, and Kwang made it easier. Simple dinners, meaningful conversations, and trips to alpine mountains and European cities made me feel at home in a foreign land. Then I met Cindy, Sundae, Jenestin, Thomas, Paulina, Fah, Hong-Bin, Leo, Ting-Wei, Pin-Yen, Yi-Kai, Edvin, Aamir, and Jirka, who changed my life completely. Cindy, my best friend, became like a real sister to me, offering a safe space and caring support. Sunday morning coffee, evening dinners, and emotional support from her made life at EPFL delightful. I want to thank all of them for being my second family in Switzerland. I also extend my gratitude to Andrea Settimi, Samy Tafasca, and Prof. Jean-Marc Odobez for introducing me to academic research and mentoring me, which paved the way for my journey to MIT.
